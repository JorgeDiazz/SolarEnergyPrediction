...
part of 'weather_5_days_forecast_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Weather5DaysForecastResponse _$Weather5DaysForecastResponseFromJson(
...
Map<String, dynamic> _$Weather5DaysForecastResponseToJson(
        Weather5DaysForecastResponse instance) =>
    <String, dynamic>{
      'cod': instance.cod,
...
WeatherClass _$WeatherClassFromJson(Map<String, dynamic> json) => WeatherClass(
      id: json['id'] as int?,
...
Map<String, dynamic> _$WeatherClassToJson(WeatherClass instance) =>
    <String, dynamic>{
      'id': instance.id,
      'main': instance.main,
